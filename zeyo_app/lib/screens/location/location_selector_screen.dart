...
class _LocationSelectorScreenState extends State<LocationSelectorScreen> {
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      await context.push('/location-map');
                      if (mounted) setState(() {});
                    },
                    borderRadius: BorderRadius.circular(12),
                    child: Container(
  ...
  Future<List<Map<String, dynamic>>> _fetchSavedAddresses() async {
    final addresses = await AddressService.getAddresses();
    // Ensuring type safety by converting
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              _buildActionItem(LucideIcons.edit, "Edit", () async {
                modalContext.pop(); // Close sheet using modal context
                await context.push('/address-details', extra: {
                  'editMode': true,
                  ...
                  'currentHouseFloor': address['house_floor'],
                  'currentApartmentArea': address['apartment_area'],
                  'currentDirections': address['directions'] is String ? address['directions'] : null,
                });
