...
import 'dart:async';
// import 'package:zeyo/features/home/presentation/screens/home_screen.dart'; // HomeScreen import to be resolved by user
      ...
      if (mounted) {
        Navigator.of(context).pushReplacement(
          PageRouteBuilder(
            ...
            transitionDuration: const Duration(milliseconds: 1000), // Match CSS 1s
          ),
        );
      }
    });
