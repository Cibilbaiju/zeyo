...
class _AddressDetailsScreenState extends State<AddressDetailsScreen> {
  ...
  void initState() {
    ...
    // Pre-fill with address line if no specific apartment area provided (New Address scenario)
    ...
    try {
      ...
      if (widget.editMode && widget.addressId != null) {
        ...
        await AddressService.addAddress({
          ...
          'address_line': widget.addressLine,
        });
      }
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          widget.currentLabel ?? 'Selected Location',
