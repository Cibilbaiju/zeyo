...
import '../../core/services/location_service.dart'; // Import Location Service
...
class _PhoneAuthScreenState extends State<PhoneAuthScreen> {
  ...
  bool _loading = false;
  Map<String, String> _selectedCountry = {'code': '+65', 'name': 'Singapore', 'flag': '🇸🇬', 'iso': 'SG'};
  ...
  Future<void> _handleVerifyOtp() async {
    ...
    try {
      ...
      final result = await AuthService.verifyOtp(phoneToVerify, otp);
      ...
      if (mounted) {
         ...
         if (mounted) {
             ...
             Provider.of<UserProvider>(context, listen: false).loginSuccess(userMap);
             final hasServices = result['has_services'] == true;
             if (hasServices) {
